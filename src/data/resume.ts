  ...
  projects: [
    {
      ...
      period: '2026.03 ~ 진행중',
      role: '풀스택 4인 팀 개발(팀장)',
      description: `3060 12GB 환경에서 vLLM·FastAPI Worker·Chroma 기반 로컬 LLM 파이프라인 구축`,
      techStack: {
        backend: 'Python, FastAPI, vLLM, LlamaIndex',
        database: 'ChromaDB',
        infra: 'CUDA, ONNX Runtime, SSE Streami ng',
      },
      responsibilities: [
        'GPU 메모리 제약을 고려해 vLLM 추론 동시성과 토큰 예산 정책을 설계',
        '요약/QA 분리형 RAG 전략을 구현하고 요청 모드별 컨텍스트 생성 경로를 구성',
        'RBAC 메타데이터 필터를 적용해 권한 범위 내 검색/요약 처리 안정성을 확보',
        'FastAPI Worker 기반 SSE 요약 API와 옵션 병합 로직을 구현',
      ],
    },
    {
