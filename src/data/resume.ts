...
지속 가능한 서버 아키텍처와 사용자 중심의 성능 개선을 추구합니다.`,
  skills: [
    {
...
랭킹 결과를 시각화된 웹 페이지에서 확인할 수 있도록 API 서버를 개발.`,
      ...
      achievements: [
        ...
        '회원별 소비 변화율 분석 결과, 중앙값 기준 2.39배, 평균 2.72배, 상위 10% 고객은 5.98배까지 증가',
        '단기 프로모션을 통해 기존 고객의 재방문 유도 및 충성 고객 소비 확대에 성공',
      ],
      github: 'https://github.com/chanii999/DayLongCafe',
    },
  ],
  education: [
    {
